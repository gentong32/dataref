...
<?= $this->section('content') ?>
    ...
    <div class="judulatas">DAFTAR PROGRAM / LAYANAN SLB PER <?=$namapilihan?></div>
            ...
            <div class="">
                <table class="table table-striped" id='table1'>
                    ...
                    <tr>
                        ...
                        <td><?=$value->nama?></td>
                        <td style="padding-left:32px;"><?=($value->tklb == '1') ? $centang : '-';?></td>
                        <td style="padding-left:32px;"><?=($value->sdlb == '1') ? $centang : '-';?></td>
                        <td style="padding-left:32px;"><?=($value->smplb == '1') ? $centang : '-';?></td>
                        <td style="padding-left:32px;"><?=($value->smlb == '1') ? $centang : '-';?></td>
