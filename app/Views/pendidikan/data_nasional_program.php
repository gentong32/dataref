...
<?= $this->section('content') ?>
    ...
    <?php } ?>
    <div class="judulatas">JUMLAH PROGRAM LAYANAN PER <?=$namapilihan?></div>
    <div class="card-body p-0">
        ...
        <div class="mytable">
           <div style="align:center;margin:auto;<?=$styletabel?>">
                ...
                <tr>
                    <td><?=$key + 1?></td>
                    <td align="left" class="link1"><a href="<?=site_url('pendidikan/program/'.
                    $tingkat.'/'.trim($value->kode_wilayah).'/'.($level+1))?>"><?php
                    if ($level==0)
                    {
