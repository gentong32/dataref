    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="judulatas">JUMLAH SATUAN PENDIDIKAN TIDAK MENGUPDATE DATA PER <?=$namapilihan?></div>
                    ...
                    <div style="align:center;margin:auto;<?=$styletabel?>">
                            ...
                            <tr>
                                ...
                                <td align="left" class="link1">
                                    <?php if($level<=2) {?>
                                    <a href="<?=site_url('pendidikan/tidakupdate/'.
...
$(document).ready( function () {
    $('#table1').DataTable({
        ...
        columnDefs: [
            ...
            { className: 'textright10', targets: [2,3,4,5,6,7] },            
        ],
