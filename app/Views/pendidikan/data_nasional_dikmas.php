    ...
    $(document).ready(function() {
        $('#table1').DataTable({
            ...
            columnDefs: [{
                ...
                <?php } else if ($jalur == "jf" && $bentuk == "all") { ?> {
                        targets: 3,
                        render: $.fn.dataTable.render.number('.', ',', 0, '')
                    },
                    {
                ...
                <?php } else if ($jalur == "jn" && $bentuk == "all") { ?> {
                        targets: 3,
                        render: $.fn.dataTable.render.number('.', ',', 0, '')
                    },
                    {
            ...
            "footerCallback": function(row, data, start, end, display) {
                ...
                <?php } elseif (($jalur == "jf") && $bentuk == "all") { ?>
                    var total2 = api
                        .column(3)
                        .data()
                        .reduce(function(a, b) {
                ...
                <?php } elseif (($jalur == "jn") && $bentuk == "all") { ?>
                    var total2 = api
                        .column(3)
                        .data()
                        .reduce(function(a, b) {
