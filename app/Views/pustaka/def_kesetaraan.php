...
<?= $this->section('content') ?>
    ...
    <div class="card-body p-0">
      <div class="menupustaka">
        ...
        Program/Layanan <b>Kesetaraan</b> merupakan program pendidikan nonformal yang menyelenggarakan pendidikan umum setara SD/MI, SMP/MTs, dan SMA/MA yang mencakup program paket A, paket B, dan paket C.
        </div>
    </div>
<?= $this->endSection() ?>
