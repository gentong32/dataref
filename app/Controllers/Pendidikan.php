...
class Pendidikan extends BaseController
{
    ...
    public function dikdas($kode = '000000', $level = 0, $jalur = "all", $bentuk = "all", $status = "all")
    {
        ...
        $datawilayah = $this->datamodelpendidikan->getDataWilayah($kode);
        $datawilayah = $datawilayah->getResult();
    ...
    public function dikmas($kode = '000000', $level = 0, $jalur = "jn", $bentuk = "all", $status = "all")
    {
        $data['tingkat'] = "dikmas";
        $data['kode'] = $kode;
        $data['level'] = $level;
    ...
    public function npsn($kode = null)
    {
        ...
        if (
            $datasekolah->bentuk_pendidikan == "PKBM" || $datasekolah->bentuk_pendidikan == "SKB"
