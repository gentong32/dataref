...
class Home extends BaseController
{
    ...
    public function index()
    {
        ...
        $pengunjungnya  = $this->datamodelpendidikan->jmlpengunjungharini($date);
        if ($pengunjungnya)
            $pengunjunghariini = $pengunjungnya->pengunjung;
        else
            $pengunjunghariini = 1;
    ...
    public function index2()
    {
        ...
        if ($ss == 0) {
            ...
            $this->datamodelpendidikan->addpengunjung(
                $ip,
                $date,
                $waktu,
                $timeinsert,
    ...
    public function cekpengunjungip()
    {
