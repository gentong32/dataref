...
{
    protected $dikdassemua = "s.bentuk_pendidikan_id=5 OR 
    s.bentuk_pendidikan_id=6 OR 
    s.bentuk_pendidikan_id=7 OR 
    s.bentuk_pendidikan_id=8 OR 
    s.bentuk_pendidikan_id=9 OR 
    s.bentuk_pendidikan_id=10 OR 
    s.bentuk_pendidikan_id=11 OR 
    s.bentuk_pendidikan_id=12 OR 
    s.bentuk_pendidikan_id=29 OR 
    s.bentuk_pendidikan_id=35 OR 
    ...
    protected $sdall = "s.bentuk_pendidikan_id=5 OR 
    s.bentuk_pendidikan_id=9";

    protected $smpall = "s.bentuk_pendidikan_id=6 OR 
    s.bentuk_pendidikan_id=10";

    protected $slb = "s.bentuk_pendidikan_id=29";
    
    protected $dikdaslainsemua = "s.bentuk_pendidikan_id=7 OR 
    s.bentuk_pendidikan_id=8 OR 
    s.bentuk_pendidikan_id=11 OR 
    s.bentuk_pendidikan_id=12 OR 
    s.bentuk_pendidikan_id=35 OR 
    ...
    protected $dikdasformal = "s.bentuk_pendidikan_id=5 OR 
    s.bentuk_pendidikan_id=6 OR 
    s.bentuk_pendidikan_id=7 OR 
    s.bentuk_pendidikan_id=8 OR 
    s.bentuk_pendidikan_id=9 OR 
    ...
    public function getTotalDikdas($status,$kode,$level,$jalur,$bentuk) {
        ...
        if ($bentuk=="all")
        {
            ...
            {
                $sql = "SELECT 
                    SUM(CASE WHEN (".$this->dikdassemua.") THEN 1 ELSE 0 END) total,
                    SUM(CASE WHEN (".$this->sdall.") THEN 1 ELSE 0 END) sdall,
                    SUM(CASE WHEN (".$this->smpall.") THEN 1 ELSE 0 END) smpall,
                    SUM(CASE WHEN (".$this->slb.") THEN 1 ELSE 0 END) slb,
                    SUM(CASE WHEN (".$this->dikdaslainsemua.") THEN 1 ELSE 0 END) lain,
    ...
    public function getDaftarBentukDikdas($jalur)
    {
        ...
        $sql = "SELECT * FROM [Referensi].[ref].[bentuk_pendidikan] s 
            WHERE (".$this->dikdassemua.") ".$wherejalur."
            ORDER BY [bentuk_pendidikan_id]";
